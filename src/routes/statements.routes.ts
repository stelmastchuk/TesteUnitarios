...
import { CreateStatementeTransferController } from '../modules/statements/useCases/createStatementTransfer/CreateStatementeTransferController';
...
const createStatementeTransferController = new CreateStatementeTransferController();
...
statementRouter.post('/transfer/:id', createStatementeTransferController.handle);
